...
1. `mart_vrm_log_hourly.vrm_log_key` — unikaalne ja not_null
2. `fct_meteo_hourly.meteo_key` — unikaalne ja not_null
3. `mart_vrm_log_hourly.battery_soc_pct` — vahemikus 0–100 (dbt_expectations)
